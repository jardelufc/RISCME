...
MAIN
		 ...
		 STR R2, [R0, #0x804] ; Escreve FF no reg de dir do GPIOem 804h
 		 STR R2, [R0, #0x804] ; Escreve FF no reg de dir do GPIOem 804h
MAINA
		 ADD R2, R0, #0x55  ; R2=0x55
		 STR R2, [R0, #0x800] ; Escreve 55 no reg de dir do GPIOem 800h
 		 STR R2, [R0, #0x800] ; Escreve 55 no reg de dir do GPIOem 800h
		 
		 add r14,r0,r15
		 b delay
		 
		 ADD R2, R0, #0xAA  ; R2=0xAA
		 STR R2, [R0, #0x800] ; Escreve AA no reg de dir do GPIOem 800h
 		 STR R2, [R0, #0x800] ; Escreve AA no reg de dir do GPIOem 800h
